...
export const JOGADAS = [
  ...
  {
    id: "ausencia", escola: "misterio", serve: "exploracao", peso: 3, sozinha: true,
  ...
  {
    id: "rosto_conhecido", escola: "mesa", serve: "social", peso: 4, precisa: "gente",
  ...
  {
    id: "objeto", escola: "formacao", serve: "exploracao", peso: 3, sozinha: true,
    quando: () => true,
  ...
  {
    id: "no_meio_do_pequeno", escola: "mesa", serve: "social", peso: 3, sozinha: true,
  ...
  {
    id: "pelo_barulho", escola: "assombro", serve: "exploracao", peso: 3, sozinha: true,
    quando: (s) => !s.emCombate,
  ...
  {
    id: "pela_multidao", escola: "saga", serve: "social", peso: 3,
    quando: (s) => s.emCidade,
  ...
  {
    id: "carta", escola: "formacao", serve: "exploracao", peso: 2,
  ...
  {
    id: "atraso", escola: "saga", serve: "exploracao", peso: 3, sozinha: true,
    quando: (s) => s.emCidade || s.emViagem,
  ...
  {
    id: "pela_crianca", escola: "picaresco", serve: "social", peso: 2,
    quando: (s) => s.emCidade && !s.emCombate,
  ...
  {
    id: "interrompido", escola: "mesa", serve: "social", peso: 3,
  ...
  {
    id: "rastro", escola: "misterio", serve: "exploracao", peso: 3, sozinha: true,
  ...
  {
    id: "pelo_cheiro", escola: "assombro", serve: "exploracao", peso: 2, sozinha: true,
    quando: (s) => !s.emCombate,
  ...
  {
    id: "quem_foge", escola: "guerra", serve: "exploracao", peso: 3,
    quando: (s) => s.emCidade || s.emViagem,
  ...
  {
    id: "pela_falta_de_reacao", escola: "assombro", serve: "social", peso: 3,
  ...
  {
    id: "espelho", escola: "tragedia", serve: "social", peso: 4, precisa: "passado",
  ...
  {
    id: "presente", escola: "tragedia", serve: "social", peso: 3,
    quando: (s) => s.ordemDaFase >= 2,
  ...
  {
    id: "conhece_meu_nome", escola: "tragedia", serve: "social", peso: 4,
  ...
  {
    id: "recruta", escola: "tragedia", serve: "social", peso: 3,
  ...
  {
    id: "custo_dele", escola: "tragedia", serve: "social", peso: 3,
    quando: (s) => s.ordemDaFase >= 3,
  ...
  {
    id: "regra_propria", escola: "tragedia", serve: "social", peso: 3,
    quando: (s) => s.ordemDaFase >= 2,
  ...
  {
    id: "paciencia", escola: "tragedia", serve: "social", peso: 3,
    quando: (s) => s.ordemDaFase >= 3,
  ...
  {
    id: "ordem_de_longe", escola: "guerra", serve: "social", peso: 3,
  ...
  {
    id: "elogio", escola: "tragedia", serve: "social", peso: 3,
    quando: (s) => s.ordemDaFase >= 3 && s.vilaoConhecido,
  ...
  {
    id: "dois_lados_ruins", escola: "tragedia", serve: "social", peso: 4,
  ...
  {
    id: "porta_aberta", escola: "tragedia", serve: "social", peso: 3,
    quando: (s) => s.ordemDaFase >= 3 && s.vilaoConhecido,
  ...
  {
    id: "trabalho_dele", escola: "guerra", serve: "exploracao", peso: 3,
    quando: (s) => s.ordemDaFase >= 2,
  ...
  {
    id: "quem_ficou", escola: "tragedia", serve: "social", peso: 3,
    quando: (s) => s.ordemDaFase >= 2 && s.emCidade,
  ...
  {
    id: "imitacao", escola: "misterio", serve: "social", peso: 3,
  ...
  {
    id: "sem_odio", escola: "tragedia", serve: "social", peso: 4,
    quando: (s) => s.ordemDaFase >= 3,
  ...
  {
    id: "conserto_pior", escola: "tragedia", serve: "exploracao", peso: 3,
  ...
  {
    id: "quem_ocupa_o_vazio", escola: "saga", serve: "social", peso: 3, precisa: "passado",
  ...
  {
    id: "preco_no_corpo", escola: "guerra", serve: "combate", peso: 3,
  ...
  {
    id: "gratidao_pesada", escola: "mesa", serve: "social", peso: 3,
  ...
  {
    id: "conta_antiga", escola: "saga", serve: "social", peso: 3, precisa: "passado",
  ...
  {
    id: "custo_de_nao_agir", escola: "tragedia", serve: "exploracao", peso: 3,
  ...
  {
    id: "recompensa_torta", escola: "picaresco", serve: "social", peso: 2,
    quando: (s) => s.emCidade,
  ...
  {
    id: "o_que_nao_volta", escola: "tragedia", serve: "social", peso: 3,
  ...
  {
    id: "fatura_dividida", escola: "guerra", serve: "social", peso: 3,
  ...
  {
    id: "ninguem_soube", escola: "tragedia", serve: "social", peso: 3,
    quando: (s) => s.momento >= 0.4,
  ...
  {
    id: "detalhe_solto", escola: "formacao", serve: "exploracao", peso: 4, sozinha: true,
  ...
  {
    id: "regra_do_lugar", escola: "assombro", serve: "exploracao", peso: 3, sozinha: true,
    quando: (s) => s.emCidade || s.emMasmorra,
  ...
  {
    id: "gente_de_fundo", escola: "formacao", serve: "social", peso: 3, sozinha: true,
    quando: (s) => s.emCidade,
  ...
  {
    id: "porta_que_nao_abri", escola: "misterio", serve: "exploracao", peso: 3, sozinha: true,
    quando: (s) => s.emCidade || s.emMasmorra,
  ...
  {
    id: "palavra_estranha", escola: "misterio", serve: "social", peso: 3,
    quando: (s) => s.pessoaNaCena || s.emCidade,
  ...
  {
    id: "habito", escola: "formacao", serve: "social", peso: 3, sozinha: true, precisa: "gente",
    quando: (s) => s.pessoaNaCena,
  ...
  {
    id: "conta_errada", escola: "misterio", serve: "exploracao", peso: 3,
    quando: (s) => s.emCidade && s.momento < 0.7,
  ...
  {
    id: "quem_olha", escola: "assombro", serve: "social", peso: 3, sozinha: true,
    quando: (s) => s.emCidade,
  ...
  {
    id: "material_errado", escola: "misterio", serve: "exploracao", peso: 2, sozinha: true,
    quando: (s) => s.emCidade || s.emMasmorra,
  ...
  {
    id: "promessa_de_terceiro", escola: "formacao", serve: "social", peso: 3,
    quando: (s) => s.emCidade && s.pessoaNaCena,
  ...
  {
    id: "medo_sem_causa", escola: "assombro", serve: "social", peso: 3,
    quando: (s) => s.emCidade,
  ...
  {
    id: "retorno_torto", escola: "formacao", serve: "social", peso: 5, precisa: "passado",
  ...
  {
    id: "eco", escola: "formacao", serve: "social", peso: 3, precisa: "passado",
  ...
  {
    id: "quem_lembra", escola: "saga", serve: "social", peso: 3, precisa: "gente",
    quando: (s) => s.emCidade && s.momento >= 0.3,
  ...
  {
    id: "o_que_plantei", escola: "formacao", serve: "exploracao", peso: 4, precisa: "passado",
    quando: (s) => s.momento >= 0.4,
  ...
  {
    id: "objeto_volta", escola: "formacao", serve: "exploracao", peso: 3, precisa: "passado",
    quando: (s) => s.momento >= 0.4,
  ...
  {
    id: "lugar_mudado", escola: "saga", serve: "exploracao", peso: 4, precisa: "passado",
  ...
  {
    id: "versao_da_minha_historia", escola: "ascensao", serve: "social", peso: 4,
    quando: (s) => s.fama >= 25,
  ...
  {
    id: "filho_da_escolha", escola: "tragedia", serve: "social", peso: 3, precisa: "passado",
    quando: (s) => s.momento >= 0.5,
  ...
  {
    id: "ferramenta_velha", escola: "formacao", serve: "combate", peso: 3,
  ...
  {
    id: "quem_aprendeu", escola: "mesa", serve: "social", peso: 3, precisa: "gente",
  ...
  {
    id: "calmaria_com_dente", escola: "mesa", serve: "exploracao", peso: 4, sozinha: true,
  ...
  {
    id: "gente_querendo", escola: "mesa", serve: "social", peso: 4, sozinha: true,
  ...
  {
    id: "riso_verdadeiro", escola: "picaresco", serve: "social", peso: 2, sozinha: true,
  ...
  {
    id: "comida", escola: "picaresco", serve: "social", peso: 3, sozinha: true,
    quando: (s) => !s.emCombate,
  ...
  {
    id: "trabalho_manual", escola: "guerra", serve: "exploracao", peso: 3, sozinha: true,
    quando: (s) => !s.emCombate,
  ...
  {
    id: "silencio_bom", escola: "mesa", serve: "social", peso: 2, sozinha: true,
  ...
  {
    id: "discussao_boba", escola: "picaresco", serve: "social", peso: 3, sozinha: true,
  ...
  {
    id: "clima", escola: "saga", serve: "exploracao", peso: 3, sozinha: true,
  ...
  {
    id: "animal", escola: "picaresco", serve: "exploracao", peso: 2, sozinha: true,
    quando: (s) => !s.emCombate,
  ...
  {
    id: "musica", escola: "picaresco", serve: "social", peso: 2, sozinha: true,
    quando: (s) => s.emCidade && !s.emCombate,
  ...
  {
    id: "conserto", escola: "guerra", serve: "exploracao", peso: 2, sozinha: true,
  ...
  {
    id: "dormir_mal", escola: "guerra", serve: "exploracao", peso: 2, sozinha: true,
    quando: (s) => s.noite,
  ...
  {
    id: "duas_portas", escola: "mesa", serve: "exploracao", peso: 4, sozinha: true,
  ...
  {
    id: "escolha_de_outro", escola: "tragedia", serve: "social", peso: 3,
  ...
  {
    id: "custo_ja_pago", escola: "mesa", serve: "exploracao", peso: 3,
    quando: (s) => s.momento >= 0.35,
  ...
  {
    id: "sem_tempo_de_saber", escola: "guerra", serve: "combate", peso: 3,
  ...
  {
    id: "quem_pede", escola: "mesa", serve: "social", peso: 3,
    quando: (s) => s.pessoaNaCena,
  ...
  {
    id: "aposta_visivel", escola: "mesa", serve: "combate", peso: 3,
    quando: (s) => s.momento >= 0.3,
  ...
  {
    id: "todo_mundo_olhando", escola: "ascensao", serve: "social", peso: 3,
  ...
  {
    id: "sem_escolha_boa", escola: "tragedia", serve: "exploracao", peso: 4,
    quando: (s) => s.momento >= 0.5,
  ...
  {
    id: "escolher_por_ultimo", escola: "misterio", serve: "exploracao", peso: 2,
  ...
  {
    id: "porta_estreita", escola: "guerra", serve: "combate", peso: 3,
  ...
  {
    id: "olhos_nos_olhos", escola: "mesa", serve: "social", peso: 4, sozinha: true,
  ...
  {
    id: "chamado_pelo_meu", escola: "mesa", serve: "combate", peso: 3, sozinha: true,
  ...
  {
    id: "nao_sou_o_assunto", escola: "mesa", serve: "social", peso: 3, sozinha: true,
    quando: (s) => s.emCidade,
  ...
  {
    id: "cobranca_de_igual", escola: "mesa", serve: "social", peso: 3, precisa: "gente",
    quando: (s) => s.pessoaNaCena && s.momento >= 0.3,
  ...
  {
    id: "expectativa", escola: "ascensao", serve: "social", peso: 3,
  ...
  {
    id: "quem_nao_se_impressiona", escola: "picaresco", serve: "social", peso: 3,
    quando: (s) => s.fama >= 25 || s.nivel >= 6,
  ...
  {
    id: "pedem_conselho", escola: "mesa", serve: "social", peso: 3,
  ...
  {
    id: "espelho_pequeno", escola: "formacao", serve: "social", peso: 3,
  ...
  {
    id: "reconhecido_pelo_errado", escola: "ascensao", serve: "social", peso: 3,
    quando: (s) => s.fama >= 25,
  ...
  {
    id: "quem_depende", escola: "tragedia", serve: "social", peso: 3,
  ...
  {
    id: "olhar_do_grupo", escola: "mesa", serve: "social", peso: 3,
    quando: (s) => s.temGrupo,
  ...
  {
    id: "confianca_cega", escola: "tragedia", serve: "social", peso: 3,
  ...
  {
    id: "numero_errado", escola: "guerra", serve: "combate", peso: 3,
    quando: (s) => s.emCombate || s.emMasmorra,
  ...
  {
    id: "vem_devagar", escola: "assombro", serve: "combate", peso: 3,
    quando: (s) => !s.emCombate,
  ...
  {
    id: "ja_estava_aqui", escola: "assombro", serve: "combate", peso: 3,
  ...
  {
    id: "sinal_do_lugar", escola: "assombro", serve: "exploracao", peso: 3, sozinha: true,
  ...
  {
    id: "perigo_com_rotina", escola: "guerra", serve: "combate", peso: 3,
  ...
  {
    id: "arma_errada", escola: "guerra", serve: "combate", peso: 3,
  ...
  {
    id: "quem_ja_tentou", escola: "saga", serve: "combate", peso: 3,
    quando: (s) => s.emCidade || s.emMasmorra,
  ...
  {
    id: "aviso_ignorado", escola: "assombro", serve: "social", peso: 3,
    quando: (s) => s.emCidade,
  ...
  {
    id: "custo_de_olhar", escola: "assombro", serve: "exploracao", peso: 2,
    quando: (s) => s.emMasmorra || s.noite,
  ...
  {
    id: "erra_de_proposito", escola: "tragedia", serve: "combate", peso: 3,
  ...
  {
    id: "perigo_que_pede", escola: "assombro", serve: "combate", peso: 3,
  ...
  /* ============ O MUNDO GRANDE ============ */
  {
    id: "vida_que_continua", escola: "saga", serve: "exploracao", peso: 3, sozinha: true,
    quando: (s) => s.emCidade || s.emViagem,
  ...
  {
    id: "preco_das_coisas", escola: "guerra", serve: "exploracao", peso: 3, sozinha: true,
    quando: (s) => s.emCidade,
  ...
  {
    id: "lei_local", escola: "guerra", serve: "social", peso: 3,
    quando: (s) => s.emCidade,
  ...
  {
    id: "noticia_de_longe", escola: "saga", serve: "exploracao", peso: 3,
    quando: (s) => s.emCidade || s.emViagem,
  ...
  {
    id: "geracao_anterior", escola: "formacao", serve: "social", peso: 3,
    quando: (s) => s.emCidade && s.momento >= 0.2,
  ...
  {
    id: "obra_em_curso", escola: "guerra", serve: "exploracao", peso: 2, sozinha: true,
    quando: (s) => s.emCidade,
  ...
  {
    id: "festa_alheia", escola: "picaresco", serve: "social", peso: 2, sozinha: true,
    quando: (s) => s.emCidade,
  ...
  {
    id: "quem_manda_aqui", escola: "guerra", serve: "social", peso: 3,
    quando: (s) => s.emCidade,
  ...
  {
    id: "fronteira", escola: "saga", serve: "exploracao", peso: 3, sozinha: true,
    quando: (s) => s.emViagem,
  ...
  {
    id: "religiao_viva", escola: "saga", serve: "social", peso: 2, sozinha: true,
    quando: (s) => s.emCidade,
  ...
  {
    id: "o_que_sobrou_da_guerra", escola: "guerra", serve: "exploracao", peso: 3,
  ...
  {
    id: "mudanca_de_estacao", escola: "saga", serve: "exploracao", peso: 2, sozinha: true,
    quando: (s) => !s.emMasmorra,
  ...
  {
    id: "fala_curta", escola: "guerra", serve: "social", peso: 3,
    quando: (s) => s.pessoaNaCena,
  ...
  {
    id: "fala_torta", escola: "picaresco", serve: "social", peso: 3, precisa: "gente",
    quando: (s) => s.pessoaNaCena,
  ...
  {
    id: "nao_responde", escola: "misterio", serve: "social", peso: 3,
    quando: (s) => s.pessoaNaCena,
  ...
  {
    id: "meio_da_conversa", escola: "mesa", serve: "social", peso: 3,
    quando: (s) => s.emCidade,
  ...
  {
    id: "mentira_pequena", escola: "misterio", serve: "social", peso: 3,
    quando: (s) => s.pessoaNaCena,
  ...
  {
    id: "verdade_inconveniente", escola: "mesa", serve: "social", peso: 3,
    quando: (s) => s.pessoaNaCena,
  ...
  {
    id: "conversa_paralela", escola: "picaresco", serve: "social", peso: 2, sozinha: true,
    quando: (s) => s.emCidade,
  ...
  {
    id: "pergunta_devolvida", escola: "mesa", serve: "social", peso: 3,
  ...
  {
    id: "quem_nao_fala_comigo", escola: "guerra", serve: "social", peso: 3,
  ...
  {
    id: "termo_tecnico", escola: "guerra", serve: "social", peso: 2,
    quando: (s) => s.pessoaNaCena,
  ...
  {
    id: "silencio_ruim", escola: "assombro", serve: "social", peso: 3,
    quando: (s) => s.pessoaNaCena && s.momento >= 0.3,
  ...
  {
    id: "espaco_apertado", escola: "guerra", serve: "combate", peso: 3,
  ...
  {
    id: "altura", escola: "saga", serve: "exploracao", peso: 3, sozinha: true,
    quando: (s) => s.emViagem || s.emCidade,
  ...
  {
    id: "lugar_usado_errado", escola: "guerra", serve: "exploracao", peso: 3, sozinha: true,
    quando: (s) => s.emCidade || s.emMasmorra,
  ...
  {
    id: "luz", escola: "assombro", serve: "exploracao", peso: 3, sozinha: true,
    quando: (s) => s.emMasmorra || s.noite,
  ...
  {
    id: "caminho_ruim", escola: "saga", serve: "exploracao", peso: 3,
    quando: (s) => s.emViagem,
  ...
  {
    id: "dentro_e_fora", escola: "assombro", serve: "exploracao", peso: 2, sozinha: true,
    quando: (s) => s.emCidade || s.emMasmorra,
  ...
  {
    id: "quem_mora_aqui", escola: "mesa", serve: "social", peso: 3, sozinha: true,
    quando: (s) => s.emMasmorra || s.emCidade,
  ...
  {
    id: "lugar_lembra", escola: "formacao", serve: "exploracao", peso: 3, precisa: "passado",
    quando: (s) => s.momento >= 0.35,
  ...
  {
    id: "obstaculo_burro", escola: "picaresco", serve: "exploracao", peso: 2,
    quando: (s) => !s.emCombate,
  ...
  {
    id: "eco_do_espaco", escola: "assombro", serve: "exploracao", peso: 2, sozinha: true,
    quando: (s) => s.emMasmorra,
  ...
  {
    id: "corte_seco", escola: "mesa", serve: "exploracao", peso: 3, sozinha: true,
    quando: (s) => s.temperatura !== "brasa",
  ...
  {
    id: "demora", escola: "guerra", serve: "exploracao", peso: 3,
    quando: (s) => !s.emCombate,
  ...
  {
    id: "hora_errada", escola: "picaresco", serve: "social", peso: 3,
    quando: (s) => s.emCidade,
  ...
  {
    id: "enquanto_isso", escola: "saga", serve: "exploracao", peso: 3,
  ...
  {
    id: "cedo_demais", escola: "misterio", serve: "exploracao", peso: 2,
    quando: (s) => s.momento < 0.5,
  ...
  {
    id: "repeticao_do_dia", escola: "guerra", serve: "exploracao", peso: 2, sozinha: true,
    quando: (s) => !s.emCombate,
  ...
  {
    id: "tarde_demais_por_pouco", escola: "tragedia", serve: "exploracao", peso: 3,
  ...
  {
    id: "sem_pressa_nenhuma", escola: "mesa", serve: "social", peso: 2, sozinha: true,
  ...
  {
    id: "cansaco", escola: "guerra", serve: "exploracao", peso: 3,
  ...
  {
    id: "cicatriz_notada", escola: "saga", serve: "social", peso: 3, precisa: "passado",
  ...
  {
    id: "fome", escola: "guerra", serve: "exploracao", peso: 2,
  ...
  {
    id: "peso", escola: "guerra", serve: "exploracao", peso: 2,
    quando: (s) => s.emViagem || s.emMasmorra,
  ...
  {
    id: "reflexo", escola: "guerra", serve: "combate", peso: 3,
  ...
  {
    id: "sangue_visivel", escola: "guerra", serve: "combate", peso: 3,
    quando: (s) => s.pvBaixo,
  ...
  {
    id: "mao_firme", escola: "mesa", serve: "combate", peso: 2,
    quando: (s) => s.nivel >= 5,
  ...
  {
    id: "corpo_do_outro", escola: "tragedia", serve: "social", peso: 3,
    quando: (s) => s.pessoaNaCena && s.momento >= 0.3,
  ...
  /* ============ A DÚVIDA ============ */
  {
    id: "coincidencia", escola: "misterio", serve: "exploracao", peso: 3,
  ...
  {
    id: "fonte_ruim", escola: "misterio", serve: "social", peso: 3,
    quando: (s) => s.emCidade,
  ...
  {
    id: "peca_que_sobra", escola: "misterio", serve: "exploracao", peso: 3,
    quando: (s) => s.momento >= 0.3,
  ...
  {
    id: "resposta_boa_demais", escola: "misterio", serve: "social", peso: 3,
    quando: (s) => s.pessoaNaCena && s.momento >= 0.3,
  ...
  {
    id: "quem_pergunta_de_mim", escola: "misterio", serve: "social", peso: 3,
  ...
  {
    id: "muda_de_ideia", escola: "misterio", serve: "social", peso: 3, precisa: "gente",
    quando: (s) => s.pessoaNaCena && s.momento >= 0.3,
  ...
  {
    id: "documento_incompleto", escola: "misterio", serve: "exploracao", peso: 2,
    quando: (s) => s.emCidade || s.emMasmorra,
  ...
  {
    id: "ninguem_concorda", escola: "misterio", serve: "social", peso: 3,
    quando: (s) => s.emCidade,
  ...
  /* ============ O VÍNCULO ============ */
  {
    id: "quem_fica", escola: "mesa", serve: "social", peso: 3,
    quando: (s) => s.temGrupo,
  ...
  {
    id: "discordancia_leal", escola: "mesa", serve: "social", peso: 3,
    quando: (s) => s.temGrupo && s.momento >= 0.3,
  ...
  {
    id: "vida_propria", escola: "mesa", serve: "social", peso: 3,
    quando: (s) => s.temGrupo,
  ...
  {
    id: "quem_apresenta", escola: "saga", serve: "social", peso: 3, precisa: "gente",
    quando: (s) => s.emCidade,
  ...
  {
    id: "favor_devolvido", escola: "saga", serve: "social", peso: 3, precisa: "passado",
    quando: (s) => s.momento >= 0.35,
  ...
  {
    id: "quem_nao_perdoou", escola: "tragedia", serve: "social", peso: 3, precisa: "passado",
    quando: (s) => s.momento >= 0.4,
  ...
  {
    id: "presenca_calada", escola: "mesa", serve: "social", peso: 2,
  ...
  {
    id: "ciume_de_ofício", escola: "picaresco", serve: "social", peso: 2,
