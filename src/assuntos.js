...
export const ASSUNTOS = [
  ...
  /* ============ O FIM DOS LAÇOS ============
     Um relacionamento que azeda sem ninguém trair é a coisa mais comum
     que existe entre pessoas, e o jogo não tinha uma linha sobre ela.
     ...
     tratam não é a ligação — é o que fica quando ela deixa de existir. */
  {
    ...
    subindo: "Os encontros ficam mais curtos e mais formais. Ninguém falta a nada; só ninguém procura mais.",
    vespera: "Nós dois estamos no mesmo lugar e nenhum dos dois atravessou a sala.",
    agora: "Agora ACONTECE: fica claro para os dois que aquilo acabou, e ninguém diz nada.",
  ...
  },
  {
    ...
    subindo: "A coisa pequena volta em outro assunto, e as posições endurecem porque agora não é mais sobre ela.",
    vespera: "Um dos dois vai dizer hoje o que vem guardando, e o outro está pronto para ouvir do jeito errado.",
    agora: "Agora ACONTECE: a briga acontece em voz alta, e alguém diz a frase que não dá para desdizer.",
  ...
  },
  {
    ...
    subindo: "Essa pessoa passa a ter assuntos, gente e problemas que não são os meus — e a explicá-los para mim.",
    vespera: "Ela me convida para o mundo dela hoje, e eu não vou saber o que dizer lá.",
    agora: "Agora ACONTECE: fica evidente que já não somos o que éramos um para o outro, e nenhum dos dois fez nada de errado.",
  ...
  },
  {
    ...
    subindo: "Aparece uma versão pequena dessa pessoa que não combina — uma mesquinharia, uma covardia miúda, uma crueldade com quem não podia revidar.",
    vespera: "Ela vai fazer de novo hoje, e desta vez eu vou estar olhando.",
    agora: "Agora ACONTECE: eu vejo, e ela sabe que eu vi.",
  ...
  },
  {
    ...
    subindo: "As conversas passam a ser sobre logística. Um dos dois começa a preencher o tempo com outra coisa.",
    vespera: "Eles vão ter a conversa hoje, e os dois já sabem qual é.",
    agora: "Agora ACONTECE: acaba, e acaba sem grito, sem culpado e sem cena.",
  ...
  },
  {
    ...
    subindo: "Ela resolve coisas maiores, e para de me contar depois.",
    vespera: "Chegou a hora de uma decisão que era minha, e ela já a tomou.",
    agora: "Agora ACONTECE: ela age sem mim, e dá certo.",
    depois: "Mostre o orgulho e o vazio no mesmo gesto — e o que eu faço com o tempo que essa pessoa me devolveu.",
  },

  /* ============ A LUTA, EM MAIS FORMAS ============ */
  {
    id: "torneio", familia: "luta", peso: 3,
    nome: "uma disputa com regras",
    quando: (s) => s.emCidade && portePeloMenos(s, "vila"),
    preparo: "Comece a preparar um TORNEIO: mostre este lugar organizando uma disputa — as regras, as inscrições, quem já ganhou antes e o que se leva.",
    subindo: "As apostas começam, alguém tenta comprar um resultado, e os favoritos passam a ser vigiados.",
    vespera: "É amanhã, e as chaves já foram sorteadas.",
    agora: "Agora ACONTECE: a disputa corre, com plateia, regras e alguém tentando burlá-las.",
    depois: "Mostre o que o torneio decidiu além do prêmio: quem perdeu dinheiro, quem ganhou nome, e quem ficou marcado por ter trapaceado.",
  },
  {
    id: "prisioneiro", familia: "luta", peso: 3,
    nome: "o que fazer com quem eu venci",
    quando: (s) => s.momento >= 0.35 && s.temDerrotado,
    preparo: "Comece a preparar a QUESTÃO DO VENCIDO: mostre este lugar lidando com alguém que perdeu uma disputa e continua vivo — onde se guarda, quem alimenta, quanto custa.",
    subindo: "Alguém quer essa pessoa: para julgar, para trocar, para calar. E cada um quer por um motivo diferente.",
    vespera: "Decidem amanhã de manhã, e um dos interessados não vai esperar.",
    agora: "Agora ACONTECE: o destino do vencido se decide, e não do jeito limpo.",
    depois: "Mostre o que a decisão disse sobre este lugar — e sobre mim, se eu tive parte nela.",
  },
  {
    id: "fera_acuada", familia: "luta", peso: 3,
    nome: "um bicho, não um monstro",
    quando: (s) => s.emViagem || chao(s, "floresta", "montanha", "colina", "pantano"),
    preparo: "Comece a preparar um BICHO: mostre o rastro de um animal grande fazendo o que animais fazem — comendo, marcando território, evitando gente.",
    subindo: "Ele passa a aparecer perto demais, e o motivo é banal: fome, filhote, ou porque tomaram o lugar dele.",
    vespera: "Está entre mim e o caminho, e não tem para onde recuar.",
    agora: "Agora ACONTECE: o encontro acontece, e o bicho age como bicho — assustado antes de bravo.",
    depois: "Mostre o que se faz com o corpo, ou o que se faz com a notícia de que ele fugiu — e o que as pessoas daqui acham do que eu fiz.",
  },
  {
    id: "bandido_com_rosto", familia: "luta", peso: 3, precisa: "gente",
    nome: "o assaltante que eu conheço",
    quando: (s) => s.emCidade && s.momento >= 0.3,
    preparo: "Comece a preparar um ROUBO: mostre alguém deste lugar em dificuldade real e visível — dívida, doença na família, trabalho que acabou.",
    subindo: "Começam os sumiços pequenos por aqui, e ninguém liga uma coisa à outra.",
    vespera: "Vi essa pessoa onde ela não tinha o que fazer, com a cara de quem foi vista.",
    agora: "Agora ACONTECE: o roubo acontece e o rosto é aquele.",
    depois: "Mostre o que este lugar faz com alguém de casa que roubou — e o que a família dessa pessoa faz depois.",
  },
  {
    id: "treino_que_sai_do_controle", familia: "luta", peso: 2,
    nome: "um treino que passa do ponto",
    quando: (s) => s.temGrupo || (s.emCidade && s.pessoaNaCena),
    preparo: "Comece a preparar um TREINO: mostre gente praticando o próprio ofício de luta, a sério e com bom humor.",
    subindo: "Uma das duplas fica mais séria que as outras, e há uma conta velha por trás disso.",
    vespera: "Os dois vão treinar juntos hoje, e ninguém propôs outra dupla.",
    agora: "Agora ACONTECE: o treino vira briga de verdade na frente de todo mundo.",
    depois: "Mostre o que fica entre os dois e o que fica entre os outros — quem separou, quem torceu, e o que se passa a evitar.",
  },
  {
    id: "ordem_de_matar", familia: "luta", peso: 3,
    nome: "mandam matar alguém",
    quando: (s) => s.momento >= 0.5 && s.ordemDaFase >= 2,
    preparo: "Comece a preparar uma ORDEM: mostre uma autoridade daqui decidindo coisas duras e sendo obedecida sem discussão.",
    subindo: "Circula um nome que essa autoridade quer fora do caminho, e o nome não é de um monstro.",
    vespera: "Vieram me procurar, e o pedido vai ser feito hoje.",
    agora: "Agora ACONTECE: a ordem é dita em voz alta, com o nome, o preço e o prazo — e a palavra volta para mim.",
    depois: "Mostre o que acontece com quem recusa e com quem aceita, e o que este lugar passa a esperar de mim.",
  },
  ...
  /* ============ O PODER, EM MAIS FORMAS ============ */
  {
    ...
    subindo: "Isso funciona, e a pessoa repete. Outros começam a usar o mesmo atalho.",
    vespera: "Alguém usou o meu nome para prometer uma coisa grande, e o prazo é hoje.",
    agora: "Agora ACONTECE: cobram de mim o que o meu nome prometeu por outra boca.",
  ...
  },
  {
    ...
    subindo: "Alguém percebe que eu tenho o que falta, e começa a rondar o assunto sem pedir.",
    vespera: "A pessoa juntou coragem e vem falar comigo agora.",
    agora: "Agora ACONTECE: ela pede, e o pedido é grande, legítimo e caro.",
  ...
  },
  {
    ...
    subindo: "Essa pessoa assume uma parte e faz DIFERENTE de como eu faria — e não pior.",
    vespera: "Ela vai tomar uma decisão grande hoje, e eu não vou estar lá.",
    agora: "Agora ACONTECE: ela decide sozinha, e a decisão é dela mesmo que eu discorde.",
  ...
  },
  {
    ...
    subindo: "Agora reparam. Alguém comenta, alguém segue, alguém muda de comportamento quando eu chego.",
    vespera: "Eu vou tentar fazer aquilo de novo hoje, e já tem gente olhando.",
    agora: "Agora ACONTECE: fica claro que aquilo acabou para mim — não por proibição, por consequência.",
  ...
  },
  {
    ...
    subindo: "Fica claro que ela precisa de alguém que aguente, e que a lista de candidatos é curta.",
    vespera: "Vão me entregar hoje, e ninguém pediu a minha opinião ainda.",
    agora: "Agora ACONTECE: a coisa fica comigo, e a palavra volta para mim.",
    depois: "Mostre o que carregá-la muda no meu dia a dia — o que eu não faço mais, e quem passa a andar por perto.",
  },

  /* ============ O ENIGMA, EM MAIS FORMAS ============ */
  {
    id: "testemunha_que_muda", familia: "enigma", peso: 3,
    nome: "a versão que mudou",
    quando: (s) => s.emCidade && s.momento >= 0.3 && s.pessoaNaCena,
    preparo: "Comece a preparar uma TESTEMUNHA: mostre alguém contando uma coisa que viu, com detalhe e convicção.",
    subindo: "Essa pessoa conta de novo, e um detalhe mudou. Ela não percebe.",
    vespera: "Vão pedir a versão dela oficialmente hoje.",
    agora: "Agora ACONTECE: ela conta a terceira versão, e desta vez alguém se beneficia claramente da mudança.",
    depois: "Mostre o que se faz com uma testemunha que já não serve — e se ela mentiu ou apenas lembrou errado fica sem resposta.",
  },
  {
    id: "mapa_que_nao_bate", familia: "enigma", peso: 3,
    nome: "o mapa que não bate com o chão",
    quando: (s) => s.emViagem || s.diasAteVizinha > 0,
    preparo: "Comece a preparar um DESENCONTRO DE MAPA: mostre alguém usando um registro do terreno — mapa, marco, conta de dias — com confiança total.",
    subindo: "O registro erra numa coisa pequena, e quem o usa corrige de cabeça sem estranhar.",
    vespera: "O próximo trecho depende inteiramente do registro, e não há como conferir antes.",
    agora: "Agora ACONTECE: o terreno é outro, e o erro não é de quem desenhou — é do que mudou depois.",
    depois: "Mostre o que a diferença custou, e quem mais está usando o mesmo registro errado agora.",
  },
  {
    id: "quem_sabia_antes", familia: "enigma", peso: 3,
    nome: "alguém já sabia",
    quando: (s) => s.momento >= 0.4 && s.emCidade,
    preparo: "Comece a preparar uma ANTECIPAÇÃO: mostre alguém tomando uma decisão estranha e cara, sem explicar por quê.",
    subindo: "A decisão começa a fazer sentido: essa pessoa se preparou para uma coisa que ainda não aconteceu.",
    vespera: "O que ela previa está a um passo, e ela já não está aqui.",
    agora: "Agora ACONTECE: a coisa acontece, e fica claro que alguém sabia com antecedência.",
    depois: "Mostre quem mais se preparou junto com ela — e quem não foi avisado.",
  },
  {
    id: "resposta_ja_dita", familia: "enigma", peso: 2, precisa: "fala",
    nome: "a resposta que já tinha sido dita",
    quando: (s) => s.momento >= 0.5,
    preparo: "Comece a preparar um RETORNO DE FALA: deixe alguém dizer uma coisa de passagem que parece só conversa, e siga em frente.",
    subindo: "O assunto volta por outro caminho, e a conversa antiga passa a fazer um sentido que não fazia.",
