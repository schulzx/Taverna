  ...
  return (
    <div className="tv-fade flex-1 flex flex-col items-center justify-center px-6 py-10">
      <div className="text-center mb-10">
        ...
        <p className="tv-mono text-[9px] uppercase tracking-[0.2em] mt-3" style={{ color: T.amberSoft }}>v8.6 · modularização (parte 1)</p>
      </div>
...
function recargaPadrao(custo) { return custo >= 6 ? 2 : custo >= 3 ? 1 : 0; }
