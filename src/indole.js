...
export const PROPOSITOS = [
  ...
  {
    id: "guardar_tumulo", nome: "guardar um túmulo",
    o: "cuida de uma cova que ninguém pode abrir — nem saber de quem é",
    precisa: "que o herói chegue perto demais do que ela protege",
    madura: (c) => c.dias >= 5,
    vira: "ela confessa o que o túmulo guarda — ou morre calada defendendo-o",
    efeito: { tipo: "missao", etapa: "falar_com", titulo: (n) => `O que ${n} enterrou` },
    exige: ["fiel", "calado", "supersticioso", "teimoso"],
  },
  {
    id: "divida_de_sangue", nome: "cobrar uma dívida de sangue",
    o: "uma vida foi tomada da família dela, e a conta segue aberta",
    precisa: "que o devedor — ou o herdeiro dele — apareça por perto",
    madura: (c) => c.forcaDoLaco >= 1 && c.dias >= 5,
    vira: "ela pede ao herói o braço que lhe falta — ou age sozinha e erra a mão",
    efeito: { tipo: "missao", etapa: "derrotar", titulo: (n) => `O sangue que ${n} cobra` },
    exige: ["rancoroso", "orgulhoso", "corajoso", "frio"],
  },
  {
    id: "recuperar_nome", nome: "limpar o próprio nome",
    o: "foi expulsa de algo por uma culpa que jura não ter",
    precisa: "que a prova da inocência passe ao alcance",
    madura: (c) => c.dias >= 6,
    vira: "ela rouba ou implora a prova — e a verdade é pior que a culpa",
    efeito: { tipo: "missao", etapa: "falar_com", titulo: (n) => `O nome de ${n}` },
    exige: ["orgulhoso", "teimoso", "desconfiado", "vaidoso"],
  },
  {
    id: "esconder_filho", nome: "esconder uma criança",
    o: "alguém procura o filho dela, e ela morreria antes de entregar",
    precisa: "que o procurador chegue à região",
    madura: (c) => c.forcaDoLaco >= 1 && c.dias >= 6,
    vira: "ela pede fuga ao herói — e a criança é semente de outra história",
    efeito: { tipo: "convite" },
    exige: ["compassivo", "medroso", "fiel", "calado"],
  },
  {
    id: "vinganca_silenciosa", nome: "vingar-se em silêncio",
    o: "sabe quem foi, e sorri para ele todo dia, esperando a hora",
    precisa: "que o alvo dela fique vulnerável — doente, em viagem, sozinho",
    madura: (c) => c.dias >= 6 && (c.sabeDeMim || c.forcaDoLaco >= 1),
    vira: "o 'acidente' acontece — e o herói é a única testemunha do sorriso de antes",
    efeito: { tipo: "relacao", relacao: "rival" },
    exige: ["rancoroso", "frio", "calado", "cruel"],
  },
  {
    id: "provar_ao_pai", nome: "provar que o pai errou",
    o: "o pai a declarou incapaz do ofício da família",
    precisa: "um desafio público do ofício, onde dê para mostrar",
    madura: (c) => c.euGanhei && c.dias >= 4,
    vira: "ela arrisca tudo no gesto — glória ou ruína, sem meio-termo",
    efeito: { tipo: "relacao", relacao: "rival" },
    exige: ["orgulhoso", "teimoso", "corajoso", "invejoso"],
  },
  {
    id: "morrer_com_honra", nome: "morrer com honra",
    o: "está doente e sabe; quer um fim que pague a vida inteira",
    precisa: "uma causa digna do fim — um cerco, um resgate, uma última linha",
    madura: (c) => c.forcaDoLaco >= 2 && c.dias >= 5,
    vira: "ela se oferece para a linha de frente — e não aceita ser poupada",
    efeito: { tipo: "relacao", relacao: "aliado" },
    exige: ["corajoso", "orgulhoso", "fiel", "humilde"],
  },
  {
    id: "sabotar_de_dentro", nome: "sabotar de dentro quem serve",
    o: "serve a quem odeia, quebrando aos poucos o que pode",
    precisa: "que o herói ameaçe o patrão dela",
    madura: (c) => c.dias >= 5 && (c.sabeDeMim || c.forcaDoLaco >= 1),
    vira: "a aliada inesperada — se o herói a notar antes do patrão",
    efeito: { tipo: "relacao", relacao: "aliado" },
    exige: ["traidor", "calado", "rancoroso", "desconfiado"],
  },
  {
    id: "encontrar_quem_partiu", nome: "encontrar quem partiu",
    o: "alguém sumiu na estrada há anos, e toda caravana é esperança",
    precisa: "que o herói viaje para onde a pista aponta",
    madura: (c) => c.forcaDoLaco >= 1 && c.dias >= 4,
    vira: "ela paga para ir junto — e o que acham não é o que ela esperava",
    efeito: { tipo: "convite" },
    exige: ["sonhador", "curioso", "fiel", "tagarela"],
  },
  {
    id: "comprar_liberdade", nome: "comprar a liberdade de alguém",
    o: "junta moeda por moeda para resgatar quem está preso ou servo",
    precisa: "que a soma quase feche — e o preço suba",
    madura: (c) => c.dias >= 6,
    vira: "ela aceita um trabalho sujo pela diferença — salvo se o herói fechar a conta",
    efeito: { tipo: "missao", etapa: "falar_com", titulo: (n) => `A liberdade que ${n} compra` },
    exige: ["generoso", "teimoso", "humilde", "compassivo"],
  },
  {
    id: "nao_ser_esquecido", nome: "não ser esquecido",
    o: "fez uma coisa grande na vida, e o mundo deu o crédito a outro",
    precisa: "que a história seja recontada errada na frente dela",
    madura: (c) => c.dias >= 5,
    vira: "ela conta a versão real — com a prova, e com o rancor",
    efeito: { tipo: "relacao", relacao: "rival" },
    exige: ["orgulhoso", "rancoroso", "vaidoso", "invejoso"],
  },
];
