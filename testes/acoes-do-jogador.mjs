...
/* ============================================================
   ...
   `declararGolpe` (`src/App.jsx:12056`) e entra no motor; FORA da luta
   ...
   (`:20805`), que é `rotulo === "Atacar" && !!vdGolpe`, e um `vdGolpe`
...
export const ACOES_DO_JOGADOR = [
  /* ---------------- AS 12 DO PAINEL "AÇÕES" ----------------
     ...
     (`src/App.jsx:21220-20821`). */
  { id: "pronta_atacar", rotulo: "Atacar", fonte: "ACOES_PRONTAS", combate: true,
    onde: "src/App.jsx:1091", handler: "src/App.jsx:21220-20821 (golpeVivo → declararGolpe; senão setEntrada)",
    texto: "Ataco ",
    ...
    alcanca: "CLIQUE, dentro da luta: declararGolpe (src/App.jsx:12056) → vereditoDoGolpeAgora (:11867) → fraseDoGolpe (src/golpe.js) → aplicarGolpeDoJogador (:11789) → resolverAtaqueJogador (:11643) → dado, dano e PV. E o clique é IMPEDIDO (`disabled={impedido}`, :20815) quando ninguém está ao alcance — a abertura de 10/10 plantas apaga o botão em vez de gastar um turno para ser recusada. CLIQUE, fora da luta: só setEntrada. FRASE, fora: porta `agressao` → abre combate e rola INICIATIVA (nenhum dado de ataque). FRASE, dentro: porta fechada → mesma porta única do clique, e no turno 1 ainda é recusada por alcance (o caminho do teclado NÃO mudou em X2)" },
  { id: "pronta_esquivar", rotulo: "Esquivar", fonte: "ACOES_PRONTAS", combate: true,
    onde: "src/App.jsx:1092", handler: "src/App.jsx:21224 (só setEntrada)",
  ...
  { id: "pronta_empurrar", rotulo: "Empurrar", fonte: "ACOES_PRONTAS", combate: true,
    onde: "src/App.jsx:1093", handler: "src/App.jsx:21224 (só setEntrada)",
  ...
  { id: "pronta_derrubar", rotulo: "Derrubar", fonte: "ACOES_PRONTAS", combate: true,
    onde: "src/App.jsx:1094", handler: "src/App.jsx:21224 (só setEntrada)",
    texto: "Tento derrubar no chão ",
    cliqueChega: "caixa", textoFora: "cena", textoLuta: "cena",
    alcanca: "nenhum leitor — cai em `cena`" },
  { id: "pronta_correr", rotulo: "Correr", fonte: "ACOES_PRONTAS", combate: true,
    onde: "src/App.jsx:1095", handler: "src/App.jsx:21224 (só setEntrada)",
  ...
  { id: "pronta_saltar", rotulo: "Saltar", fonte: "ACOES_PRONTAS", combate: false,
    onde: "src/App.jsx:1096", handler: "src/App.jsx:21224 (só setEntrada)",
    texto: "Salto sobre ",
    cliqueChega: "caixa", textoFora: "motor", textoLuta: "motor",
    alcanca: "casa desafio (tipo `teste`) → adjudicarAcao (src/App.jsx:16265) rola o dado" },
  { id: "pronta_esconder", rotulo: "Esconder", fonte: "ACOES_PRONTAS", combate: false,
    onde: "src/App.jsx:1097", handler: "src/App.jsx:21224 (só setEntrada)",
  ...
  { id: "pronta_procurar", rotulo: "Procurar", fonte: "ACOES_PRONTAS", combate: false,
    onde: "src/App.jsx:1098", handler: "src/App.jsx:21224 (só setEntrada)",
    texto: "Examino o lugar com atenção, procurando ",
    cliqueChega: "caixa", textoFora: "motor", textoLuta: "motor",
    alcanca: "casa desafio (tipo `teste`) → rola o dado" },
  { id: "pronta_ajudar", rotulo: "Ajudar", fonte: "ACOES_PRONTAS", combate: true,
    onde: "src/App.jsx:1099", handler: "src/App.jsx:21224 (só setEntrada)",
    texto: "Ajudo ",
    cliqueChega: "caixa", textoFora: "cena", textoLuta: "cena",
  ...
  /* ---------------- AS 8 DO PAINEL RÁPIDO ----------------
     ...
     `onClick` (`src/App.jsx:21268`) → `declararAcaoRapida` (`:16112`)
     → `adjudicarAcao` (`:15861`) → dado.
  ...
  { id: "rapida_buscar", rotulo: "Vasculhar", fonte: "ACOES_RAPIDAS", combate: false,
    onde: "src/desafios.js:622", handler: "src/App.jsx:21268 → declararAcaoRapida",
  ...
  { id: "rapida_investigar", rotulo: "Investigar", fonte: "ACOES_RAPIDAS", combate: false,
    onde: "src/desafios.js:623", handler: "src/App.jsx:21268 → declararAcaoRapida",
  ...
  { id: "rapida_escutar", rotulo: "Escutar", fonte: "ACOES_RAPIDAS", combate: false,
    onde: "src/desafios.js:624", handler: "src/App.jsx:21268 → declararAcaoRapida",
    texto: "encosto o ouvido e escuto com atenção",
    cliqueChega: "motor", textoFora: "motor", textoLuta: "motor", alcanca: "desafio `teste` → rola" },
  { id: "rapida_fraqueza", rotulo: "Lembrar", fonte: "ACOES_RAPIDAS", combate: false,
    onde: "src/desafios.js:625", handler: "src/App.jsx:21268 → declararAcaoRapida",
  ...
  { id: "rapida_convencer", rotulo: "Convencer", fonte: "ACOES_RAPIDAS", combate: false,
    onde: "src/desafios.js:626", handler: "src/App.jsx:21268 → declararAcaoRapida",
    texto: "tento convencer",
    cliqueChega: "motor", textoFora: "motor", textoLuta: "motor", alcanca: "desafio `teste` → rola" },
  { id: "rapida_intimidar", rotulo: "Intimidar", fonte: "ACOES_RAPIDAS", combate: false,
    onde: "src/desafios.js:627", handler: "src/App.jsx:21268 → declararAcaoRapida",
    texto: "intimido",
    cliqueChega: "motor", textoFora: "motor", textoLuta: "motor", alcanca: "desafio `teste` → rola" },
  { id: "rapida_furtar_se", rotulo: "Esgueirar", fonte: "ACOES_RAPIDAS", combate: false,
    onde: "src/desafios.js:628", handler: "src/App.jsx:21268 → declararAcaoRapida",
    texto: "me esgueiro sem ser visto",
    cliqueChega: "motor", textoFora: "motor", textoLuta: "motor", alcanca: "desafio `teste` → rola" },
  { id: "rapida_tranca", rotulo: "Arrombar", fonte: "ACOES_RAPIDAS", combate: false,
    onde: "src/desafios.js:632", handler: "src/App.jsx:21268 → declararAcaoRapida",
  ...
  { id: "grid_mover", rotulo: "Mover no grid", fonte: "grid", combate: true,
    onde: "src/App.jsx:21147 (onMover)", handler: "clique no quadrado → moverPara (src/App.jsx:14859)",
    texto: null,
    cliqueChega: "motor", textoFora: null, textoLuta: null,
    alcanca: "muda x,y do herói (src/App.jsx:14926) e gasta o movimento da economia" },
  { id: "bolsa_consumivel", rotulo: "Beber da bolsa", fonte: "bolsa", combate: true,
    onde: "src/App.jsx:19895", handler: "clique em `usar` → usarConsumivelUI",
    texto: null,
    cliqueChega: "motor", textoFora: null, textoLuta: null,
  ...
  { id: "heroismo_gasto", rotulo: "Gastar heroísmo", fonte: "heroismo", combate: true,
    onde: "src/App.jsx:15532", handler: "PainelHeroismo (src/painel-heroismo.jsx:106) → aoGastar",
    texto: null,
    cliqueChega: "motor", textoFora: null, textoLuta: null,
    ...
    alcanca: "gastarHeroismo desconta o ponto. O gasto `refazer` (src/App.jsx:15524) só existe com um dado na tela — e ATÉ X1 o jogador não conseguia rolar nenhum em combate; desde X2 o clique de `Atacar` rola" },
  { id: "texto_ataque", rotulo: "Texto livre de ataque", fonte: "teclado", combate: true,
    onde: "src/App.jsx:13669", handler: "caixa de texto → agirInterno → aplicarGolpeDoJogador",
    texto: "Ataco <alvo>",
    ...
    /* X2 NÃO MEXEU NO CAMINHO DO TECLADO — e é de propósito que esta
       ...
       `agirInterno` e virou `aplicarGolpeDoJogador` (:11789), que hoje tem
       dois chamadores — o texto e o botão — e uma só aplicação. */
    alcanca: "fora: `lerAgressao` (src/agressao.js:177) exige alvo REGISTRADO no elenco; 7 de 8 frases naturais morrem em `semAlvoConhecido`. dentro: chega a aplicarGolpeDoJogador (src/App.jsx:11954) → resolverAtaqueJogador (:11643) e é recusado por alcance no turno 1 (ver ABERTURA_FORA_DE_ALCANCE)" },
];
...
export const MOTOR_SEM_CHAMADOR = {
  ...
  escritoENuncaLido: [
    { campo: "combate.recursos", escritoEm: "src/App.jsx:5280",
...
export const NAO_CONTA_COMO_NUMERO = [
  ...
  /* O ENDEREÇO MUDOU DE NOVO (X4), E DESTA VEZ COM CATRACA. Era `12959` em
     ...
     `src/App.jsx:13502` — o arquivo cresceu por baixo dele duas vezes e
  ...
  { o: "o relógio do mundo (45 min)", porque:
    "src/App.jsx:13502 avança MINUTOS_POR_TURNO em todo turno fora de combate, faça o jogador o que fizer. Um número que muda sempre não distingue turno que fez de turno que não fez: incluí-lo daria 0% de esterilidade por construção e a medida perderia o sentido" },
];
...
/* ============================================================
   ...
   `semAlcance` (`src/App.jsx:11874-11713`) sai em `:11794-11757` ANTES de
   gastar a ação — deliberadamente, por `:11791-11753` ("golpe sem
   alcance não gasta a ação"). Sem gastar a ação, `fecharMeuTurno` →
   `resolverRevide` (`src/App.jsx:14481-14264`) nunca roda: o inimigo
   ...
   perguntado sem gastar o turno (`vereditoDoGolpeAgora`, `:11867`), e
...
export const ABERTURA_FORA_DE_ALCANCE = {
  ...
  recusaDeGraca: {
    ...
    ondeRecusa: "src/App.jsx:11874-11713 (resolverAtaqueJogador)",
    ondeSai: "src/App.jsx:11959-11962 (aplicarGolpeDoJogador)",
    naoGastaAcao: "src/App.jsx:11956-11793",
    logo: "fecharMeuTurno/resolverRevide (src/App.jsx:14481-14264) nunca roda — o inimigo também não age",
  },
...
/* ============================================================
   ...
   X3b escreveu em prosa: "`pushMsgs` é `App.jsx:7553` e treze funções o
   chamam dentro do combate". O endereço do funil CONFERE — `pushMsgs` é
   `src/App.jsx:7553`, e há 453 call-sites dele em 174 funções no arquivo
   ...
   O que NÃO entrou no funil, e por quê: `agirInterno` (`:13218`), o
   ...
   UMA CHAMADA NÃO É UMA LINHA. `pushMsgs` recebe uma lista: `:11960`
...
export const FUNIL_DO_COMBATE = [
  { fn: "presencaNaLuta", onde: "src/App.jsx:5460", anel: "nucleo",
    linhas: [
      { onde: "src/App.jsx:5497", evento: "presença divina na abertura da luta — condição imposta ao herói, ao grupo ou aos inimigos",
        voz: "frase", nasce: "src/presenca-divina.js (resolverPresenca, presencaDoHeroiEmCombate)" },
    ] },
  { fn: "aMesaEspera", onde: "src/App.jsx:7570", anel: "borda",
    linhas: [
      { onde: "src/App.jsx:7574", evento: "a trava do turno guardado: o motor já rolou e a narração não chegou",
        voz: "recusa", nasce: "src/App.jsx" },
    ] },
  { fn: "tentarReacaoNoGolpe", onde: "src/App.jsx:7813", anel: "nucleo",
    linhas: [
      { onde: "src/App.jsx:7831", evento: "a reação dispara (aparar, esquivar, retribuir)",
        voz: "frase", nasce: "src/reacoes.js (resolverReacao)" },
      { onde: "src/App.jsx:7856", evento: "o contra-ataque da reação acerta ou erra",
        voz: "telegrama", nasce: "src/App.jsx" },
    ] },
  { fn: "aplicarCondicoesDosGolpes", onde: "src/App.jsx:7863", anel: "nucleo",
    linhas: [
      { onde: "src/App.jsx:7887", evento: "o golpe do inimigo impõe (ou não) uma aflição ao herói",
        voz: "frase", nasce: "src/aflicoes.js (rolarAflicao)" },
    ] },
  { fn: "limparConjuracoesDaLuta", onde: "src/App.jsx:7975", anel: "borda",
    linhas: [
      { onde: "src/App.jsx:7982", evento: "a forma animal se desfaz ao fim da luta",
        voz: "frase", nasce: "src/habilidades.js (desfazerForma)" },
      { onde: "src/App.jsx:7989", evento: "a guarda do herói baixa ao fim da luta",
        voz: "frase", nasce: "src/habilidades.js (baixarGuardas)" },
      { onde: "src/App.jsx:8006", evento: "a guarda de cada companheiro baixa ao fim da luta",
        voz: "frase", nasce: "src/habilidades.js (baixarGuardas)" },
      { onde: "src/App.jsx:8012", evento: "a pressa acaba ao fim da luta",
        voz: "frase", nasce: "src/habilidades.js (baixarPressa)" },
    ] },
  { fn: "aflicaoDeCompanheiro", onde: "src/App.jsx:8310", anel: "nucleo",
    linhas: [
      { onde: "src/App.jsx:8317", evento: "a arma do companheiro envenena/queima o inimigo",
        voz: "frase", nasce: "src/aflicoes.js (rolarAflicao)" },
    ] },
  { fn: "resolverAtaqueJogador", onde: "src/App.jsx:11923", anel: "nucleo",
    linhas: [
      { onde: "src/App.jsx:12047", evento: "atacou, apareceu — a invisibilidade se rompe pelo golpe",
        voz: "frase", nasce: "src/gatilhos.js (romperPorGatilho)" },
    ] },
  { fn: "aplicarGolpeDoJogador", onde: "src/App.jsx:12069", anel: "nucleo",
    /* núcleo por COMPORTAMENTO e não por guarda própria: sem luta,
       ...
       `:11913` com `false`, sem falar. É a função que a sessão A percorre
       sete vezes. */
    linhas: [
      { onde: "src/App.jsx:12075", evento: "recusa por alcance — o golpe digitado não alcança ninguém",
        voz: "recusa", nasce: "src/App.jsx:11990 (o literal do motivo)" },
      { onde: "src/App.jsx:12083", evento: "recusa por economia — a ação da rodada já saiu",
        voz: "recusa", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:12125", evento: "o golpe do jogador: dano, PV do alvo e a aflição da arma",
        voz: "telegrama", misto: true, nasce: "src/App.jsx (o ⚔) + src/aflicoes.js (a aflição)" },
    ] },
  { fn: "declararGolpe", onde: "src/App.jsx:12178", anel: "nucleo",
    ...
    linhas: [
      { onde: "src/App.jsx:12193", evento: "recusa por alcance — o clique chegou e o veredito diz não",
        voz: "recusa", nasce: "src/App.jsx:1139 (recusaDoGolpe)" },
    ] },
  { fn: "resolverHabilidadeOfensiva", onde: "src/App.jsx:12213", anel: "nucleo",
    linhas: [
      { onde: "src/App.jsx:12239", evento: "a ceifa leva de uma vez quem estava abaixo do limiar",
        voz: "frase", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:12241", evento: "a ceifa varre o campo e não acha ninguém abaixo do limiar",
        voz: "frase", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:12340", evento: "o alvo está abaixo do limiar e a execução vale",
        voz: "telegrama", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:12568", evento: "a habilidade ofensiva resolvida: acerto, dano, dreno, imunidade por degrau",
        voz: "telegrama", misto: true, nasce: "src/App.jsx" },
    ] },
  { fn: "fecharSeTodosCairam", onde: "src/App.jsx:13887", anel: "borda",
    linhas: [
      { onde: "src/App.jsx:13904", evento: "a forma animal se desfaz quando a luta acaba",
        voz: "frase", nasce: "src/habilidades.js (desfazerForma)" },
      { onde: "src/App.jsx:13918", evento: "a luta termina sem ninguém derrotado — sem espólios",
        voz: "frase", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:14012", evento: "vitória: todos caíram, e os espólios",
        voz: "telegrama", misto: true, nasce: "src/App.jsx" },
    ] },
  { fn: "resolverRevide", onde: "src/App.jsx:14045", anel: "nucleo",
    ...
    linhas: [
      { onde: "src/App.jsx:14064", evento: "abre a vez do mundo e diz a rodada",
        voz: "telegrama", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:14082", evento: "o inimigo dá as costas e leva o golpe de oportunidade",
        voz: "frase", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:14113", evento: "o passo do inimigo no tabuleiro",
        voz: "frase", nasce: "src/App.jsx:5453 (linhaDePasso)" },
      { onde: "src/App.jsx:14132", evento: "o passo do aliado no tabuleiro",
        voz: "frase", nasce: "src/App.jsx:5453 (linhaDePasso)" },
      { onde: "src/App.jsx:14304", evento: "o golpe de cada inimigo: acerto, dano, amortecimento, abrigo",
        voz: "telegrama", misto: true, nasce: "src/App.jsx (o ⚔) + src/tracos.js (amortecerDano)" },
      { onde: "src/App.jsx:14343", evento: "a concentração cai com o dano sofrido",
        voz: "frase", nasce: "src/combate.js (testeConcentracao)" },
      { onde: "src/App.jsx:14355", evento: "o dano rompe a invisibilidade",
        voz: "frase", nasce: "src/gatilhos.js (romperPorGatilho)" },
      { onde: "src/App.jsx:14369", evento: "a Dádiva da Recuperação segura a queda",
        voz: "frase", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:14377", evento: "a guarda segura a queda em 1 PV",
        voz: "frase", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:14389", evento: "a fúria persistente segura a queda em 1 PV",
        voz: "frase", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:14421", evento: "Voz de Comando: as invocadas agem de novo",
        voz: "frase", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:14428", evento: "a rolagem do golpe do companheiro (só com `mostrarRolagens`)",
        voz: "telegrama", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:14434", evento: "o golpe do companheiro: dano ou erro",
        voz: "telegrama", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:14438", evento: "a rolagem da habilidade do companheiro (só com `mostrarRolagens`)",
        voz: "telegrama", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:14444", evento: "a arma do companheiro impõe aflição",
        voz: "frase", nasce: "src/aflicoes.js (rolarAflicao)" },
      { onde: "src/App.jsx:14447", evento: "a habilidade ofensiva do companheiro",
        voz: "telegrama", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:14452", evento: "a cura do companheiro num aliado",
        voz: "telegrama", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:14457", evento: "o companheiro bebe uma poção",
        voz: "frase", nasce: "src/App.jsx:8209 (pocaoDeCompanheiro)" },
      { onde: "src/App.jsx:14462", evento: "o companheiro ergue um buff",
        voz: "frase", nasce: "src/App.jsx:8234 (buffDeCompanheiro)" },
      { onde: "src/App.jsx:14464", evento: "e o que ele largou para erguê-lo",
        voz: "frase", nasce: "src/App.jsx:8234 (buffDeCompanheiro)" },
      { onde: "src/App.jsx:14494", evento: "o companheiro ergue uma guarda",
        voz: "frase", nasce: "src/habilidades.js (GUARDAS, erguerGuarda)" },
      { onde: "src/App.jsx:14501", evento: "recusa por repetição — a guarda que já está de pé não sobe duas vezes",
        voz: "recusa", nasce: "src/App.jsx (a recusa nasce em src/habilidades.js, erguerGuarda; a frase é do App)" },
      { onde: "src/App.jsx:14526", evento: "o herói chega a zero e rola a queda",
        voz: "frase", nasce: "src/App.jsx:8351 (resolverQueda)" },
      { onde: "src/App.jsx:14541", evento: "a forma animal vence o prazo",
        voz: "frase", nasce: "src/habilidades.js (expirarForma)" },
      { onde: "src/App.jsx:14549", evento: "a guarda do herói vence o prazo",
        voz: "frase", nasce: "src/habilidades.js (expirarGuardas)" },
      { onde: "src/App.jsx:14568", evento: "a guarda de cada companheiro vence o prazo",
        voz: "frase", nasce: "src/habilidades.js (expirarGuardas)" },
      { onde: "src/App.jsx:14575", evento: "a pressa vence o prazo",
        voz: "frase", nasce: "src/habilidades.js (expirarPressa)" },
      { onde: "src/App.jsx:14582", evento: "o controle sobre o inimigo arrebenta",
        voz: "frase", nasce: "src/controle.js (expirarControles)" },
      { onde: "src/App.jsx:14590", evento: "a invocação se desfaz no fim do prazo",
        voz: "frase", nasce: "src/invocacoes.js (expirarInvocacoes)" },
    ] },
  { fn: "moverPara", onde: "src/App.jsx:14988", anel: "nucleo",
    linhas: [
      { onde: "src/App.jsx:14993", evento: "recusa — esta luta não tem terreno",
        voz: "recusa", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:15006", evento: "recusa — uma condição prende o herói no lugar",
        voz: "recusa", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:15017", evento: "recusa por economia — o movimento da rodada acabou",
        voz: "recusa", nasce: "src/App.jsx" },
      { onde: "src/App.jsx:15023", evento: "recusa do passo — fora do campo, ocupado, longe demais, já está aí",
        voz: "recusa", nasce: "src/grid.js:473-508 (caminhar)" },
      { onde: "src/App.jsx:15057", evento: "o passo sai: golpes de oportunidade de quem te alcança e o abrigo",
        voz: "frase", misto: true, nasce: "src/App.jsx" },
    ] },
  { fn: "virarChefeSePreciso", onde: "src/App.jsx:18423", anel: "nucleo",
    linhas: [
      { onde: "src/App.jsx:18437", evento: "o chefe da masmorra vira de fase",
...
/* ============================================================
   ...
   uma, e o 15 não sai de nenhum dos dois cortes possíveis:
     ...
     **25 formas distintas** — cada literal que o jogador pode ler.
       Uma só chamada imprime cinco frases diferentes (`:14619`, que
       repassa os cinco motivos de `caminhar`), e outra imprime três
       (`:12021`, via `recusaDoGolpe`). O campo `formas` diz quantas.
   ...
   (`usarHeroismo`, `src/App.jsx:15661-15300`, seis literais `⛔`): elas
   ...
   funil; `despachante` é `agirInterno` (`src/App.jsx:13390`), que fala
...
export const RECUSAS_DO_COMBATE = [
  ...
  { familia: "alcance", onde: "src/App.jsx:12075", fn: "aplicarGolpeDoJogador", anel: "nucleo", formas: 2,
  ...
  { familia: "alcance", onde: "src/App.jsx:12193", fn: "declararGolpe", anel: "nucleo", formas: 3,
  ...
  { familia: "alcance", onde: "src/App.jsx:13668", fn: "agirInterno", anel: "despachante", formas: 1,
    ...
    nasce: "src/App.jsx:12314" },
  { familia: "alcance", onde: "src/App.jsx:13801", fn: "agirInterno", anel: "despachante", formas: 1,
    literal: "📏 <o mesmo motivo de :12142> — os <n> PM voltaram.",
    nasce: "src/App.jsx:12314" },
  { familia: "alcance", onde: "src/App.jsx:14993", fn: "moverPara", anel: "nucleo", formas: 1,
    literal: "📏 Esta luta não tem terreno definido.", nasce: "src/App.jsx" },
  { familia: "alcance", onde: "src/App.jsx:15023", fn: "moverPara", anel: "nucleo", formas: 5,
  ...
  { familia: "economia", onde: "src/App.jsx:12083", fn: "aplicarGolpeDoJogador", anel: "nucleo", formas: 1,
    literal: "⏳ Você já usou sua ação nesta rodada — o golpe fica para a próxima.",
    nasce: "src/App.jsx" },
  { familia: "economia", onde: "src/App.jsx:13576", fn: "agirInterno", anel: "despachante", formas: 1,
    literal: "Mana insuficiente para <habilidade> — parei antes dela.", nasce: "src/App.jsx" },
  { familia: "economia", onde: "src/App.jsx:13578", fn: "agirInterno", anel: "despachante", formas: 1,
    literal: "⏳ <habilidade> está em recarga (<n>t) — pulei.", nasce: "src/App.jsx" },
  { familia: "economia", onde: "src/App.jsx:13582", fn: "agirInterno", anel: "despachante", formas: 1,
    literal: "⏳ Sua ação deste turno já saiu — <habilidade> fica para a próxima rodada.",
    nasce: "src/App.jsx" },
  { familia: "economia", onde: "src/App.jsx:15017", fn: "moverPara", anel: "nucleo", formas: 1,
    literal: "⏳ Você já cobriu os <n> m desta rodada — o próximo passo é no turno que vem.",
    nasce: "src/App.jsx" },

  /* ---- teto: uma por vez ---- */
  { familia: "teto", onde: "src/App.jsx:13587", fn: "agirInterno", anel: "despachante", formas: 1,
  ...
  { familia: "repeticao", onde: "src/App.jsx:14501", fn: "resolverRevide", anel: "nucleo", formas: 1,
  ...
  { familia: "turno-guardado", onde: "src/App.jsx:7574", fn: "aMesaEspera", anel: "borda", formas: 1,
  ...
  { familia: "conjuracao", onde: "src/App.jsx:13557", fn: "agirInterno", anel: "despachante", formas: 1,
    literal: "⛓ <habilidade> não sai: você não consegue conjurar vestindo <peça>. Tire a peça e tente de novo.",
    nasce: "src/App.jsx" },
  { familia: "conjuracao", onde: "src/App.jsx:13564", fn: "agirInterno", anel: "despachante", formas: 1,
    literal: "🐾 <habilidade> não sai: em <forma> você não tem mão nem voz para conjurar.",
    nasce: "src/App.jsx" },
  { familia: "conjuracao", onde: "src/App.jsx:13568", fn: "agirInterno", anel: "despachante", formas: 1,
    literal: "📕 <motivo de podeLancar>", nasce: "src/magias.js (podeLancar)" },

  /* ---- a condição que prende: a segunda que X3b não nomeou ---- */
  { familia: "condicao", onde: "src/App.jsx:15006", fn: "moverPara", anel: "nucleo", formas: 1,
...
/* ============================================================
   ...
   `:13502` não avança o relógio (há luta aberta) e em `:13822` cai na
   porta única. `resolverAtaqueJogador` devolve `semAlcance` em
   `:11988-11952`, e `aplicarGolpeDoJogador` sai em `:12074-12037`
   empurrando DUAS linhas — o eco do jogador e a recusa — e devolvendo
   `true` ANTES do `enviar(...)` de `:12141`. Logo o Narrador não é
...
export const SESSAO_A_PELA_FRASE = {
  ...
  ondeSai: "src/App.jsx:12075 (a recusa) — o `return true` de :12076 antecede o enviar de :12141",
...
export const O_QUE_NAO_DEU_PARA_MEDIR = [
  ...
  { o: "se a linha misturada é frase ou telegrama, quando a chamada empurra as duas",
    porque: "`:11960`, `:14083`, `:12396`, `:13830` e `:14653` empurram listas montadas em tempo de execução. O campo `misto: true` marca as cinco; a `voz` declarada é a da linha que o jogador sempre vê, e a outra fica no `nasce`. Contar as duas exigiria executar o App" },
